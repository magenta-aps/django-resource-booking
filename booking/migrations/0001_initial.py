    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.ForeignKey(default=None, blank=True, to='booking.EmailTemplateType', null=True, verbose_name='Template type', on_delete=django.db.models.deletion.SET_NULL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guest', models.ForeignKey(blank=True, to='booking.Guest', null=True, on_delete=django.db.models.deletion.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizationalunit', models.ForeignKey(blank=True, to='booking.OrganizationalUnit', null=True, on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluation', models.ForeignKey(blank=True, to='booking.SurveyXactEvaluation', null=True, on_delete=django.db.models.deletion.CASCADE)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='cancelled_visits', default=None, blank=True, to='booking.EventTime', null=True, verbose_name='Tidspunkt for aflyst bes\xf8g', on_delete=django.db.models.deletion.SET_NULL),
        ),
        migrations.AddField(
            model_name='visit',
        ...
        migrations.AddField(
            model_name='resource',
            name='organizationalunit',
            field=models.ForeignKey(verbose_name='Ressourcens enhed', to='booking.OrganizationalUnit', on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
            model_name='resource',
            name='resource_type',
        ...
        migrations.AddField(
            model_name='guest',
            name='school',
            field=models.ForeignKey(verbose_name='Skole', to='booking.School', null=True, on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='autosend',
            name='template_type',
            field=models.ForeignKey(to='booking.EmailTemplateType', null=True, on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='locality',
            field=models.ForeignKey(verbose_name='Lokalitet', blank=True, to='booking.Locality', null=True, on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
